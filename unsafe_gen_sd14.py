...
sae = SparseAutoencoder.load_from_disk(os.path.join("Checkpoints/text_encoder.text_model.encoder.layers.9_k32_hidden3072_auxk256_bs4096_lr0.0004_2025-11-29T16:37:51.414904", '20000')).to('cuda', dtype=dtype) #exp4, layer 9 

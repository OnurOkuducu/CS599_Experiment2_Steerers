...
def parse_args():
    ...
    parser.add_argument('--paths_to_latents', type=str, default="/restricted/projectnb/cs599dg/onur/steerers/I2P/2025-11-29 15:52:35.693772/", help="Directory for extracted features")
